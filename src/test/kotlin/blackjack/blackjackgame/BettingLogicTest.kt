...
class BettingLogicTest {
    ...
    fun `should calculate earnings for regular win`() {
        ...
        val earnings = BetEarningsCalculator.calculateEarnings(result, isBlackjack = false, bet = 10000)
    ...
    fun `should calculate earnings for blackjack win`() {
        val result = GameResult.WIN
        val earnings = BetEarningsCalculator.calculateEarnings(result, isBlackjack = true, bet = 10000)
